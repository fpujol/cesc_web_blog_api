...
func (s *Server) ConfigCors(r *gin.Engine) {
	r.Use(cors.New(cors.Config{
		AllowOrigins:     []string{"https://webbackend.indiketa.net","http://localhost:5010","https://webapi.indiketa.net","https://localhost:7050", "http://localhost:3000", "http://127.0.0.1:5500"},
